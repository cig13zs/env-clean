...
Normalize environment-variable names, remove duplicates, and replace values with safe example placeholders.

[Open the web app](https://cig13zs.github.io/env-clean/)
